...
router.post('/', function(req, res, next) {
  let addMd = db.prepare("INSERT INTO mdsaves (title, author, category, created, md, child, child_of) VALUES (@title, @author, @category, @created, @md, @child, @child_of);");
  let author = req.body.author ? req.body.author : 'JDK';
  const dbObject = { title: req.body.title, author: author, category: req.body.category, md: req.body.markdown, created: req.body.created, child: req.body.childBool, child_of: req.body.child_of};
  addMd.run(dbObject);
